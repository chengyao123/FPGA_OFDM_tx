...
HD_PWD='F:/F_prj/ofdm_7.12/ofdm_tx/ofdm_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ofdm_transmitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ofdm_transmitter.tcl

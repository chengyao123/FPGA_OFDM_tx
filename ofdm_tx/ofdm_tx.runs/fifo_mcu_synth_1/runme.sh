...
HD_PWD='F:/F_prj/ofdm/ofdm_tx/ofdm_tx.runs/fifo_mcu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_mcu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_mcu.tcl

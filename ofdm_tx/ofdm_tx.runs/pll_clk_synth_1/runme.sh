...
HD_PWD='F:/F_prj/ofdm/ofdm_tx/ofdm_tx.runs/pll_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_clk.tcl
